...
public class VMP3
{
    ...
    public void WriteFarmHeader()
    {
        farmfile.Write("VMP3ID" + "\t" + "farmType" + "\t" + "farmArea" + "\t" + "entericCH4CO2Eq" + "\t" + "manureCH4CO2Eq" + "\t" + "manureN2OCO2Eq" + "\t" +
                  "housingNH3CO2Eq" + "\t" + "manurestoreNH3CO2Eq" + "\t" + "fieldCH4CO2Eq.ToString" + "\t" + "fieldN2OCO2Eq" + 
                   "\t" + "fieldfertNH3CO2Eq" + "\t" + "fieldmanureNH3CO2Eq" + "\t" + "leachedNCO2Eq" + "\t" +
                  "totalGHGCO2Eq" + "\t" +
                  "housingNH3Loss" + "\t" + "manureNH3Emission" + "\t" + "Nleaching" +
                  "\t" + "fertNapplied" + "\t" + "manNapplied" + "\t" + "manureToFieldN");
        farmfile.WriteLine("");
    }
    public void WriteFieldHeader()
    {
        fieldfile.Write("VMP3ID" + "\t" + "IMK_ID" + "\t" + "area"+ "\t" + "areaProportion" + "\t" +
            ...
            "\t" + "leachedNCO2Eq" + "\t" + "leachedN"+ "\t"  + "NH3Nemission" + "\t" + "Nunaccounted"
            + "\t" + "crop" + "\t" + "fertN" + "\t" + "ManType1" + "\t" + "ManN1" + "\t" + "ManType2" + "\t" + "ManN2");
        fieldfile.WriteLine("");
    }
}
